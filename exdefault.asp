...
<html lang="en-GB" class="theme-light">
    <head>
        <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-S44BBPDTJW"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-S44BBPDTJW');
</script>
        <meta charset="UTF-8">
        ...
        <title>Latent Defects - Independent Building Warranty Brokers - Get your Project Certified Today!</title>
        <meta name="description" content="We are Latent Defects - UK Independent Building Warranty Brokers - Get A Free Quote For Cover For Your Building Project Today!">
...
- (Finance)
- (Other Insurnace)
- Insolvence/Receship warranties)
- (Alpha CRL)
- (Contact us)-->
                    <li class="nav-item">
                        <a class="nav-link" href="#">New Devs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Conversions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Social Housing</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Self-Build</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Retrospective</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">PCC's</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Alpha/CRL</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Other Cover</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="container">
                ...
                <!--<div class="copyright-area">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="copyright-item">
                                <p>© Nofa is Proudly Owned by <a href="https://hibootstrap.com/" target="_blank">HiBootstrap</a></p>
                            </div>
                        </div>
                    </div>
                </div>-->
